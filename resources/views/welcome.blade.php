            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card h-100 shadow-sm feature-card text-center border-0">
                            <div class="card-body p-4">
                                <img src="assets/img/gallery/comment.png" alt="Komunikasi" class="mb-3"
                                    style="width:60px;height:60px;" />
                                <h5 class="fw-bold">Komunikasi Terpusat</h5>
                                <p class="text-muted">Pesan & pengumuman internal untuk memudahkan koordinasi antara
                                    pengurus dan mahasiswa.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card h-100 shadow-sm feature-card text-center border-0">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted">Kelola biodata, status beasiswa, dan riwayat kegiatan setiap
