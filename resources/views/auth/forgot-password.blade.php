        ...
        <div class="p-6">
            ...
            <div class="info-box mb-6">
                <p class="text-gray-700 text-sm">
                    Lupa kata sandi? Tidak masalah. Beri tahu kami alamat email Anda dan kami akan mengirimkan link
                    reset kata sandi yang memungkinkan Anda memilih yang baru.
                </p>
            </div>
            ...
            <div class="text-center">
                <p class="text-gray-600 text-sm">Hubungi kami di
                    <a href="mailto:support@example.com"
                        class="font-bold orange-text hover:text-orange-800 transition-colors">support@example.com</a>
                </p>
            </div>
        </div>
    </div>
